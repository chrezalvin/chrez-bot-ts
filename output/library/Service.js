...
class Service {
     ...
     */
    async _getById(id) {
        const docRef = (0, lite_1.doc)(Service.db, this.m_dbName, id);
     ...
     */
    async _getAllData() {
        const q = (0, lite_1.query)((0, lite_1.collection)(Service.db, this.m_dbName));
    ...
    async _addData(data, id) {
        if (id) {
            ...
            const ref = (0, lite_1.collection)(Service.db, this.m_dbName);
    ...
    async _batchDelete(ids) {
        const batch = (0, lite_1.writeBatch)(Service.db);
        for (const id of ids) {
            const docRef = (0, lite_1.doc)(Service.db, this.m_dbName, id);
            batch.delete(docRef);
        }
...
Service.s_services = [];
Service.db = (0, lite_1.getFirestore)(_config_1.firebaseApp);
