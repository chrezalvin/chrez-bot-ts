...
(function (CommandStatuses) {
    ...
    CommandStatuses[CommandStatuses["hidden"] = 2] = "hidden";
    ...
    async execute(message, args) {
        ...
        if ((0, _library_1.isChatInputCommandInteraction)(message)) {
            ...
            if (this.m_slash === undefined)
                return new _library_1.ErrorValidation("slash_command_option_unavailable");
            params = this.m_slash.getParameter?.(message);
            if (_library_1.ErrorValidation.isErrorValidation(params)) {
            ...
            if (this.m_chat === undefined)
                return new _library_1.ErrorValidation("chat_command_option_unavailable");
